                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">공고 등록</h1>
                            </div>
                            <br>
                            	<h4>회사 정보</h4>
                            	<hr>
                            	...
                            	<div class="form-group row" style = "background-color:#fbfbfb; padding: 34px 30px 35px; ">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <h6>홈페이지 주소 &nbsp; : &nbsp;&nbsp; <%= article.getCOMP_TEL()%></h6>  
                            ...
                            <form class="user" name="member_form" method="post" enctype="multipart/form-data" action="jobFormPro.jsp">
                            	<br>
                            	<input type="hidden" name="job_id" value="<%=id %>">		<!-- 넘길 것 히든으로 넘기기 ********************************************************** -->
                            	
                            	<div class="form-group row">
                            		 <div class="col-sm-9 mb-3 mb-sm-0">
	                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"	name = "job_subject"
	                                            placeholder="공고 제목">
		                             </div>
                            		 <div class="col-sm-3 mb-3 mb-sm-0">
                            	...
                            	<br>
                                    <div class="" style = "text-align:center; height: 600px;">										    
                                        <textarea name="job_content" style = "width: 100%; height: 600px;"></textarea>
                                    </div>
                                    <br>
	                            	<hr>
	                            	<br>
	                            	<div class="form-group row" id = "datelabel">
	                                    <div class="col-sm-4">
	                                        ...
	                                        <input type="date" class="form-control form-control-user" id="exampleInputEmail"	name = "job_edate"
                                         placeholder="">
	                                    </div>
	                                    <div class="col-sm-4">
	                                    	<label>&nbsp;&nbsp;</label>
	                                        <select name="job_caeer" class="combo" id=selectedbox>
	                                    ...
	                                    <div class="col-sm-4">
	                                    	<label>&nbsp;&nbsp;</label>
	                                        <select name="job_stu" class="combo" id=selectedbox>
	                                ...
	                                <div class="form-group row" id = "datelabel">
	                                    <div class="col-sm-4 mb-3 mb-sm-0">
	                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"	name = "job_money"
	                                            placeholder="급여(3천만원 이상)">
		                             	</div>
	                                    <div class="col-sm-4">
	                                        <select name="job_empl" class="combo" id=selectedbox>
	                                    ...
	                                    <div class="col-sm-4">
	                                        <select name="job_up" class="combo" id=selectedbox>
	                            	...
	                            	<div class="form-group row" id = "datelabel">
	                                    <div class="col-sm-2 mb-2 mb-sm-0">
	                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"	name = "job_head"
	                                            placeholder="모집 인원">
		                             	</div>
		                             	<div class="col-sm-3">
	                                        <select name="job_area" class="combo" id=selectedbox>
	                                    ...
	                                    <div class="col-sm-4 mb-2 mb-sm-0">
	                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"	name = "job_cond"
	                                            placeholder="근무 조건(주 5일 오전 9시 ~ 오후 6시)">
		                             	</div>
	                                    <div class="col-sm-3 mb-2 mb-sm-0">
	                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"	name = "job_job"
	                                            placeholder="담당 업무">
		                             	</div>
	                                </div>
                            	<br>                                
