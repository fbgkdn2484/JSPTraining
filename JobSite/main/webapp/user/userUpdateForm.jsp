                            ...
                            <form class="user" name="member_form" method="post" action="userFormPro.jsp">
                            	...
                            	<div class="form-group row">
                                     ...
                                     <div class="col-sm-4 mb-3 mb-sm-0">
	                            		 <select name="user_mil_mil" class="combo mil_type" id=user_mil_mil >
                                     ...
                                     <div class="col-sm-3 mb-3 mb-sm-0">
	                            		 <select name="user_mil_type" class="combo mil" id = user_mil_type disabled>
                                     ...
                                     <div class="col-sm-3 mb-3 mb-sm-0">
	                            		 <select name="user_mil_rnk" class="combo mil" id = user_mil_rnk disabled>
                            	...
                            	<br>
	                            	...
	                            	<div id = "middle">
	                            		...
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-6">
		                                        <select name="user_mid_area" class="combo input_middle_class" id = user_mid_area>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    <div class="col-sm-5 mb-3 mb-sm-0">
		                                    	<label for = "exampleInputEmail">입학 연도</label>
		                                       	<input type="date" class="form-control form-control-user input_middle_class" id="input_middle"	name = "user_mid_sdate"		value = "<%= uvo.getUser_mid_sdate() %>"
	                                         placeholder="">
		                                    </div>
		                                    <div class="col-sm-5">
		                                    	<label for = "exampleInputEmail">졸업 연도</label>
		                                        <input type="date" class="form-control form-control-user input_middle_class" id="input_middle"	name = "user_mid_edate"		value = "<%= uvo.getUser_mid_edate() %>"
	                                         placeholder="">
		                                    </div>
		                                    <div class="col-sm-2">
		                                    	<label for = "selectedbox">&nbsp;&nbsp;</label>
		                                        <select name="user_mid_grad" class="combo input_middle_class" id=user_mid_grad>
	...
	<!-- 	                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"	name = "user_high_name"
	                                	...
	                                	<div id = "GED_bot">
		                            		<div class="form-group row" >
			                                    ...
			                                    <div class="col-sm-4">
			                                        <select name="user_high_area" class="combo input_high_class high_bot" id=user_high_area>
														<option value="" selected disabled hidden>지역 선택</option>
									           			<option value="서울">서울</option>
									           			<option value="부산">부산</option>
									           			<option value="대구">대구</option>
			                                    ...
			                                    <div class="col-sm-4">
			                                        <select name="user_high_major" class="combo input_high_class high_bot" id=user_high_major>
		                                	 ...
		                                	 <br>
				                                <div class="form-group row" id = "datelabel">
				                                    ...
				                                    <div class="col-sm-2">
				                                    	<label for = "selectedbox">&nbsp;&nbsp;</label>
				                                        <select name="user_high_grad" class="combo input_high_class high_bot" id = user_high_grad>
															<option value="" selected disabled hidden>졸업 여부</option>
										           			<option value="졸업">졸업</option>
										           			<option value="중퇴">중퇴</option>
										       			</select>
	                                ...
	                                <hr>
	                            		...
	                            		<br>
		                            		<div class="form-group row">
		                            			<div class="col-sm-4">
			                                        <select name="user_univ_type1" class="combo input_uni_class" id = user_univ_type1>
			                                    ...
			                                    <div class="col-sm-4">
			                                        <select name="user_univ_area1" class="combo input_uni_class" id = user_univ_area1>
														<option value="" selected disabled hidden>지역 선택</option>
									           			<option value="서울">서울</option>
									           			<option value="부산">부산</option>
									           			<option value="대구">대구</option>
			                                ...
			                                <div class="form-group row" id = "datelabel">
			                                    ...
			                                    <div class="col-sm-2">
			                                    	<label for = "selectedbox">&nbsp;&nbsp;</label>
			                                        <select name="user_univ_grad1" class="combo input_uni_class" id = user_univ_grad1>
														<option value="" selected disabled hidden>졸업 여부</option>
									           			<option value="졸업">졸업</option>
									           			<option value="중퇴">중퇴</option>
									       			</select>
			                                ...
			                                <div class="form-group row" id = "datelabel">
			                                    <div class="col-sm-5">
			                                        <select name="user_univ_major1" class="combo input_uni_class" id = user_univ_major1>
			                                    ...
			                                    <div class="col-sm-3">
			                                        <select name="user_univ_nm1" class="combo input_uni_class" id = user_univ_nm1>
	                            		...
	                            		<br>
		                            		<div class="form-group row">
		                            			<div class="col-sm-4">
			                                        <select name="user_univ_type2" class="combo input_uni_class input_uni_class2" id = user_univ_type2>
														<option value="" selected disabled hidden>대학 구분</option>
									           			<option value="10">대학(2,3년)</option>
									           			<option value="11">대학교(4년)</option>
									           			<option value="12">대학원(석사)</option>
			                                    ...
			                                    <div class="col-sm-4">
			                                        <select name="user_univ_area2" class="combo input_uni_class input_uni_class2" id=user_univ_area2>
														<option value="" selected disabled hidden>지역 선택</option>
									           			<option value="서울">서울</option>
									           			<option value="부산">부산</option>
									           			<option value="대구">대구</option>
			                                ...
			                                <div class="form-group row" id = "datelabel">
			                                    ...
			                                    <div class="col-sm-2">
			                                    	<label for = "selectedbox">&nbsp;&nbsp;</label>
			                                        <select name="user_univ_grad2" class="combo input_uni_class input_uni_class2" id = user_univ_grad2>
														<option value="" selected disabled hidden>졸업 여부</option>
									           			<option value="졸업">졸업</option>
									           			<option value="중퇴">중퇴</option>
									       			</select>
			                                ...
			                                <div class="form-group row" id = "datelabel">
			                                    <div class="col-sm-5">
			                                        <select name="user_univ_major2" class="combo input_uni_class input_uni_class2" id = user_univ_major2>
														<option value="" selected disabled hidden>전공</option>
									           			<option value="1">영어/영문</option>
									           			<option value="2">중어/중문</option>
									           			<option value="3">일어/일문</option>
			                                    ...
			                                    <div class="col-sm-3">
			                                        <select name="user_univ_nm2" class="combo input_uni_class input_uni_class2" id = user_univ_nm2>
			                                        	<option value="" selected disabled hidden>주/야간</option>
									           			<option value="주간">주간</option>
									           			<option value="야간">야간</option>
									       			</select>
                            		...
                            		<br>
	                            		<div class="form-group row">
	                            			<div class="col-sm-4">
		                                        <select name="user_univ_type3" class="combo input_uni_class input_uni_class3" id = user_univ_type3>
													<option value="" selected disabled hidden>대학 구분</option>
								           			<option value="10">대학(2,3년)</option>
								           			<option value="11">대학교(4년)</option>
								           			<option value="12">대학원(석사)</option>
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_univ_area3" class="combo input_uni_class input_uni_class3" id=user_univ_area3>
													<option value="" selected disabled hidden>지역 선택</option>
								           			<option value="서울">서울</option>
								           			<option value="부산">부산</option>
								           			<option value="대구">대구</option>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    ...
		                                    <div class="col-sm-2">
		                                    	<label for = "selectedbox">&nbsp;&nbsp;</label>
		                                        <select name="user_univ_grad3" class="combo input_uni_class input_uni_class3" id=user_univ_grad3>
													<option value="" selected disabled hidden >졸업 여부</option>
								           			<option value="졸업">졸업</option>
								           			<option value="중퇴">중퇴</option>
								       			</select>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    <div class="col-sm-5">
		                                        <select name="user_univ_major3" class="combo input_uni_class input_uni_class3" id=user_univ_major3>
													<option value="" selected disabled hidden>전공</option>
								           			<option value="1">영어/영문</option>
								           			<option value="2">중어/중문</option>
								           			<option value="3">일어/일문</option>
		                                    ...
		                                    <div class="col-sm-3">
		                                        <select name="user_univ_nm3" class="combo input_uni_class input_uni_class3"  id=user_univ_nm3>
		                                        	<option value="" selected disabled hidden>주/야간</option>
								           			<option value="주간">주간</option>
								           			<option value="야간">야간</option>
								       			</select>
                            	...
                            	<div id = "car">
                            		...
                            		<br>
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_area1" class="combo input_car input_car1" id=user_caeer_area1>
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_leave1" class="combo input_car input_car1" id=user_caeer_leave1>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_jobt1" class="combo input_car input_car1" id=user_caeer_jobt1>
                            	...
                            	<div id = "car2">
                            		...
                            		<br>
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_area2" class="combo input_car input_car2" id=user_caeer_area2>
													<option value="" selected disabled hidden>근무 지역</option>
								           			<option value="서울">서울</option>
								           			<option value="부산">부산</option>
								           			<option value="대구">대구</option>
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_leave2" class="combo input_car input_car2" id=user_caeer_leave2>
													<option value="" selected disabled hidden>퇴사사유</option>
								           			<option value="20">계약만료</option>
								           			<option value="21">경영악화</option>
								           			<option value="22">근무조건</option>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_jobt2" class="combo input_car input_car2" id=user_caeer_jobt2>
													<option value="" selected disabled hidden>직위</option>
								           			<option value="1">인턴/수습</option>
								           			<option value="2">사원</option>
								           			<option value="3">주임</option>
                            	...
                            	<div id = "car3">
                            		...
                            		<br>
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_area3" class="combo input_car input_car3" id=user_caeer_area3>
													<option value="" selected disabled hidden>근무 지역</option>
								           			<option value="서울">서울</option>
								           			<option value="부산">부산</option>
								           			<option value="대구">대구</option>
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_leave3" class="combo input_car input_car3" id=user_caeer_leave3>
													<option value="" selected disabled hidden>퇴사사유</option>
								           			<option value="20">계약만료</option>
								           			<option value="21">경영악화</option>
								           			<option value="22">근무조건</option>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_jobt3" class="combo input_car input_car3" id=user_caeer_jobt3>
													<option value="" selected disabled hidden>직위</option>
								           			<option value="1">인턴/수습</option>
								           			<option value="2">사원</option>
								           			<option value="3">주임</option>
                            	...
                            	<div id = "car4">
                            		...
                            		<br>
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_area4" class="combo input_car input_car4" id=user_caeer_area4>
													<option value="" selected disabled hidden>근무 지역</option>
								           			<option value="서울">서울</option>
								           			<option value="부산">부산</option>
								           			<option value="대구">대구</option>
		                                    ...
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_leave4" class="combo input_car input_car4" id=user_caeer_leave4>
													<option value="" selected disabled hidden>퇴사사유</option>
								           			<option value="20">계약만료</option>
								           			<option value="21">경영악화</option>
								           			<option value="22">근무조건</option>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    <div class="col-sm-4">
		                                        <select name="user_caeer_jobt4" class="combo input_car input_car4" id=user_caeer_jobt4>
													<option value="" selected disabled hidden>직위</option>
								           			<option value="1">인턴/수습</option>
								           			<option value="2">사원</option>
								           			<option value="3">주임</option>
                                ...
                                <div id = "lic1">
                            		...
                            		<br>
	                            		<div class="form-group row">
	                            			<div class="col-sm-4">
		                                        <select name="user_licen_type1" class="combo input_li1" id=user_licen_type1>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    ...
		                                    <div class="col-sm-4">
		                                    	<label for = "selectedbox">&nbsp;</label>
		                                        <select name="user_licen_pass1" class="combo input_li1" id=user_licen_pass1>
                            	...
                            	<div id = "lic2">
                            		...
                            		<br>
	                            		<div class="form-group row">
	                            			<div class="col-sm-4">
		                                        <select name="user_licen_type2" class="combo input_li2" id=user_licen_type2>
													<option value="" selected disabled hidden>항목 선택</option>
								           			<option value="자격증/면허증">자격증/면허증</option>
								           			<option value="어학시험">어학시험</option>
								           			<option value="수상내역/공모전">수상내역/공모전</option>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    ...
		                                    <div class="col-sm-4">
		                                    	<label for = "selectedbox">&nbsp;</label>
		                                        <select name="user_licen_pass2" class="combo input_li2" id=user_licen_pass2>
													<option value="" selected disabled hidden>합격 구분</option>
								           			<option value="1차합격">1차합격</option>
								           			<option value="2차합격">2차합격</option>
								           			<option value="필기합격">필기합격</option>
                            	...
                            	<div id = "lic3">
                            		...
                            		<br>
	                            		<div class="form-group row">
	                            			<div class="col-sm-4">
		                                        <select name="user_licen_type3" class="combo input_li3" id=user_licen_type3>
													<option value="" selected disabled hidden>항목 선택</option>
								           			<option value="자격증/면허증">자격증/면허증</option>
								           			<option value="어학시험">어학시험</option>
								           			<option value="수상내역/공모전">수상내역/공모전</option>
		                                ...
		                                <div class="form-group row" id = "datelabel">
		                                    ...
		                                    <div class="col-sm-4">
		                                    	<label for = "selectedbox">&nbsp;</label>
		                                        <select name="user_licen_pass3" class="combo input_li3" id=user_licen_pass3>
													<option value="" selected disabled hidden>합격 구분</option>
								           			<option value="1차합격">1차합격</option>
								           			<option value="2차합격">2차합격</option>
								           			<option value="필기합격">필기합격</option>
